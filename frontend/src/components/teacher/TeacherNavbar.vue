      ...
      <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        <div class="relative flex flex-1 items-center">
          ...
          <input
            ...
            class="h-10 w-full max-w-md rounded-xl border-0 bg-gray-100 dark:bg-gray-700 pl-10 pr-4 text-sm text-gray-900 dark:text-white placeholder:text-gray-400 focus:ring-2 focus:ring-primary-500"
          />
        </div>
        ...
        <div class="flex items-center gap-x-2 sm:gap-x-4">
          ...
          >
            ...
            <span
              v-if="unreadCount > 0"
              class="absolute -top-1 -right-1 h-5 w-5 rounded-full bg-red-500 flex items-center justify-center text-xs font-bold text-white"
            >
