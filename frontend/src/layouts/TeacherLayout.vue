<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div class="lg:hidden">
        ...
        >
          <div class="fixed inset-y-0 left-0 z-50 w-72 bg-white shadow-xl dark:bg-gray-800">
            <TeacherSidebarContent @close="sidebarOpen = false" />
          </div>
        </TransitionChild>
      </div>
    </TransitionRoot>
    ...
    <div class="lg:pl-72">
      <!-- Navbar -->
      <TeacherNavbar @toggle-sidebar="sidebarOpen = !sidebarOpen" />
...
import TeacherSidebarContent from '@/components/teacher/TeacherSidebarContent.vue'
